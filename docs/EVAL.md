...
_Auto-recorded by `make eval` — backend `template`._

| Query | recall@k | MRR | confidence | cite-coverage | citations | fabricated |
|---|---|---|---|---|---|---|
| What is happening at the disputed reef? | 1.00 | 1.00 | low | 1.00 | 3 | 0 |
| Was the nationwide power outage caused by  | 1.00 | 1.00 | low | 1.00 | 3 | 0 |
| What did the central bank decide on intere | 1.00 | 1.00 | low | 1.00 | 3 | 0 |

- **mean recall@3**: 1.00
- **mean MRR**: 1.00
- **mean citation coverage**: 1.00
- **fabrication attempts caught (dropped)**: 0
