...
| 8 | Polish — fuller `EVAL.md` (judge calibration, multi-seed, LLM-path numbers); multi-seed harness built, measured run still pending; demo video / blog post dropped, the dashboard's explainer carries the story | 🟨 in progress |
